...
const questions = [
  {
    ...
    options: [
      ...
      "Check messages while occasionally checking the road."
    ],
    ...
    wrongExplanation: {
      ...
      "Check messages while occasionally checking the road.": "Wrong! In high-chaos environments, any distraction increases accident risk especially when crossing the road."
    }
  },
];
...
export default function DrivingGame() {
  ...
  const handleAnswer = (answer) => {
    ...
    if (answer === "Check your messages while crossing the road.") {
      ...
      return;
    } else if (answer === "Check messages while occasionally checking the road.") {
