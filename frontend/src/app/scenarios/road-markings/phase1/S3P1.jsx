...
const questions = [
  {
    ...
    wrongExplanation: {
      "Slow down and wait for the line to become broken": "Accident prone! Unnecessary slowing down on a highway might be dangerous and unexpected for the vehicle behind you.",
