  ...
  const updateProgress = async (scenarioId, selectedOption, isCorrect) => {
    try {
      ...
      if (attemptResponse.ok) {
        console.log('S8P1: ✅ Progress updated successfully');
      } else {
        console.log('S8P1: ⚠️ Failed to update progress:', attemptResponse.status);
      }
    } catch (error) {
      console.log('S8P1: ❌ Error updating progress:', error.message);
    }
  };
