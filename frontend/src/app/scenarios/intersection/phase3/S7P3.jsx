...
const npcCarSprites = {
  ...
  yellow: [
    require("../../../../../assets/car/JEEP TOPDOWN/Yellow/MOVE/EAST/SEPARATED/Yellow_JEEP_CLEAN_EAST_000.png"),
    require("../../../../../assets/car/JEEP TOPDOWN/Yellow/MOVE/EAST/SEPARATED/Yellow_JEEP_CLEAN_EAST_001.png"),
  ],
};
...
export default function DrivingGame() {
  ...
  const handleAnswer = async (answer) => {  
    ...
    if (answer === "Enter the roundabout immediately after the jeepney passed") {
