...
const questions = [
  {
    question:
      "You're driving along Tagaytay's ridge road during the early morning when you see a SLIPPERY ROAD sign. The road appears dry, but you notice dew formation on your windshield and surrounding vegetation.",
    options: [
      "Continue at normal speed since the road looks dry",
      "Reduce speed and avoid sudden steering, braking, or acceleration",
      "Turn on hazard lights and drive very slowly",
    ],
    correct: "Reduce speed and avoid sudden steering, braking, or acceleration",
    correctExplanation:
      "correct! Slippery road signs require smooth, gentle driving inputs and reduced speed regardless of appearance.",
    wrongExplanation: {
      "Continue at normal speed since the road looks dry":
        "Wrong! Road surface conditions can change quickly; warning signs indicate potential rather than visible hazards. Pay attention to your surroundings to know potential indicators",
      "Turn on hazard lights and drive very slowly":
        "Wrong! Hazard lights are for stopped/slow vehicles in emergencies, not for normal cautious driving. This may confuse fellow drivers",
    },
  },
];

const warningSignSprites = {
  floodRiskArea: require("../../../../../assets/signs/slippery.png"),
};
...
function DrivingGameContent() {
  ...
  const handleAnswer = (answer) => {
    ...
    let duration = 5000;
    if (answer === "Reduce speed and avoid sudden steering, braking, or acceleration") {
      duration = 8000; // Slow speed - correct answer (smooth, careful driving)
    } else if (answer === "Continue at normal speed since the road looks dry") {
      duration = 4000; // Normal speed - wrong answer (ignoring warning)
    } else if (answer === " Turn on hazard lights and drive very slowly") {
      duration = 10000; // Very slow speed - wrong answer (overly cautious)
    }
  ...
  const handleNext = async () => {
    ...
    if (questionIndex < questions.length - 1) {
      ...
      moveToNextScenario();
      router.push("scenarios/traffic-signs/phase3/S7P3");
    }
  };
