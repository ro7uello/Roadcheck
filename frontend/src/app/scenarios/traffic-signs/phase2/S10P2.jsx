...
const questions = [
  {
    ...
    options: ["Drive normally since you're in the car lane", "Reduce speed, maintain safe distance from bicycle lane, and be extra cautious of cyclists", "Use the bicycle lane to accommodate more cars in the road."],
...
export default function DrivingGame() {
  ...
  const handleAnswer = async (answer) => {
    ...
    } else if(answer === "Use the bicycle lane to accommodate more cars in the road."){
        const targetRow = 9;
        const rowsToMove = targetRow - currentRow;
        const nextTarget = currentScroll.current + rowsToMove * tileSize;
