...
export default function PedestrianGame() {
  ...
  const handleRoadMarkingsPress = () => {
    ...
    ]).start(() => router.push('/pedestrian-game/road-markings'));
  };
  ...
  const handleSignsPress = () => {
    ...
    ]).start(() => router.push('/pedestrian-game/signs'));
  };
  ...
  const handleIntersectionPress = () => {
    ...
    ]).start(() => router.push('/pedestrian-game/intersections'));
  };
...
const styles = StyleSheet.create({
  ...
  carImage: { width: 200, height: 100 },
  backButton: { position: 'absolute', top: 40, left: 20, backgroundColor: 'rgba(0,0,0,0.6)', width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', zIndex: 5 },
  ...
  iconButton: { backgroundColor: 'rgba(0,0,0,0.6)', width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginLeft: 10 },
  topIcon: { width: 24, height: 24 },
  titleContainer: { position: 'absolute', top: 10, alignSelf: 'center', zIndex: 3 },
  title: { fontSize: 60, fontWeight: 'bold', color: 'white', fontFamily: 'pixel', textShadowColor: '#000', textShadowOffset: { width: 3, height: 3 }, textShadowRadius: 6, letterSpacing: 4 },
  ...
  optionLabel: { fontSize: 12, fontWeight: 'bold', color: 'white', fontFamily: 'pixel', textAlign: 'center', textShadowColor: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2, bottom: -40 },
});