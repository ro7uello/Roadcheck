    ...
    const progressInterval = setInterval(() => {
      setLoadingProgress(prev => {
        ...
        if (newProgress >= 100) {
          ...
          setTimeout(() => {
            // Navigate to option page after loading
            console.log("Navigating to /option-screen"); 
...
const styles = StyleSheet.create({
  ...
  carContainer: { position: 'absolute', bottom: -30, left: width * 0.05, zIndex: 2 },
  carImage: { width: 440, height: 210 },
  contentContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', zIndex: 3, paddingHorizontal: 40 },
  titleContainer: { marginBottom: 60 },
  title: {
    fontSize: 54,
    color: '#fff',
    fontFamily: 'Pixel3',
  ...
  loadingSection: { alignItems: 'center', marginBottom: 40 },
  loadingText: {
    fontSize: 24,
    color: 'white',
    fontFamily: 'Pixel3',
  ...
  loadingBar: { height: '100%', backgroundColor: '#FFD700', borderRadius: 7, position: 'absolute', top: 0, left: 0 },
  loadingBarShine: { height: '100%', backgroundColor: '#FFED4E', borderRadius: 7, position: 'absolute', top: 0, left: 0, opacity: 0.5 },
  percentageText: { fontSize: 18, color: '#FFD700', fontFamily: 'Pixel3', textShadowColor: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2, minWidth: 50, textAlign: 'center' },
  subtitle: { fontSize: 16, color: 'rgba(255,255,255,0.8)', fontFamily: 'Pixel3', textAlign: 'center', textShadowColor: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
});
